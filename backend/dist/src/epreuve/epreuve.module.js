...
const epreuve_controller_1 = require("../epreuve/epreuve.controller");
const epreuve_service_1 = require("../epreuve/epreuve.service");
let EpreuveModule = class EpreuveModule {
};
EpreuveModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([epreuve_entity_1.Epreuve])],
        controllers: [epreuve_controller_1.EpreuveController],
        providers: [epreuve_service_1.EpreuveSerivce],
    })
], EpreuveModule);
