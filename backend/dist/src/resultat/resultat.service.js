...
exports.ResultatService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const resultat_entity_1 = require("./entities/resultat.entity");
const typeorm_2 = require("typeorm");
let ResultatService = class ResultatService {
    constructor(resultatRepository) {
        this.resultatRepository = resultatRepository;
    }
    create(resultat) {
        return this.resultatRepository.save(this.resultatRepository.create(resultat));
    }
    findAll() {
    ...
    delete(id) {
        return this.resultatRepository
            .createQueryBuilder()
            .delete()
            .from(resultat_entity_1.Resultat)
            .where('codeResultat = :id', { id })
            .execute();
    }
};
ResultatService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(resultat_entity_1.Resultat)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ResultatService);
exports.ResultatService = ResultatService;
